...
if (isset($_POST['tambah'])) {
  ...
  if (tambahPS($_POST) > 0) {
    echo "<script>
            alert('data ps berhasil disimpan');
            document.location.href = 'data-ps.php';
          </script>";
  } else {
    echo "<script>
            alert('data ps gagal disimpan');
            document.location.href = 'data-ps.php';
          </script>";
  }
}
          ...
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark">
                ...
                <li>
                  <a class="dropdown-item" href="#">Orderan</a>
                </li>
                <li>
                  <hr class="dropdown-divider" />
                </li>
      ...
      <div class="col-md-6 mx-auto">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Tambah Data PS</h4>
          </div>
          <div class="card-body">
            <form action="" method="post" id="profileForm">
              <div class="mb-3">
                <label for="nama_playstation" class="form-label">Nama PlayStation</label>
                <input type="text" class="form-control" id="nama_playstation" name="nama_playstation" required />
              </div>
              <div class="mb-3">
